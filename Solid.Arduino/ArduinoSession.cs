...
//#endif
                ...
                else
                {
                    ...
                    {
                        Console.WriteLine("[SerialDataReceived] Calling ProcessCommand");
                        // Process Firmata command byte.
                        ProcessCommand(serialByte);
                    }
                    else
                    {
                        Console.WriteLine("[SerialDataReceived] Calling ProcessAsciiString");
        ...
        private void ProcessCommand(int serialByte)
        {
            ...
            Console.WriteLine("[ProcessCommand] header is " + header);
